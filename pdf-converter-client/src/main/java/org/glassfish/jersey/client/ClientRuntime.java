...
class ClientRuntime {
    ...
    /**
     * Submit a {@link org.glassfish.jersey.client.ClientRequest client request} for asynchronous processing.
     * <p>
     * Both, the request processing as well as response callback invocation will be executed
     * in a context of an active {@link org.glassfish.jersey.process.internal.RequestScope.Instance request scope instance}.
     * </p>
     *
     ...
     * {@link org.glassfish.jersey.process.internal.RequestScope.Instance request scope instance}. A caller may use the
    ...
    public void close() {
        connector.close();
        asyncExecutorsFactory.getRequestingExecutor(null).shutdown(); // This line was added by rafwin (see pom.xml).
    }
