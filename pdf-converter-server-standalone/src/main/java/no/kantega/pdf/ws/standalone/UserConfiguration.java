...
public class UserConfiguration {
    ...
    public static final String ARGUMENT_LONG_THREAD_POOL_CORE_SIZE = "core-size";
    public static final String ARGUMENT_SHORT_THREAD_POOL_CORE_SIZE = "S";
    public static final String DESCRIPTION_ARGUMENT_THREAD_POOL_CORE_SIZE = "The number of threads constantly " +
            "ready to process conversions.";
    public static final String DESCRIPTION_CONTEXT_THREAD_POOL_CORE_SIZE = "These threads will be constantly held ready for picking " +
    ...
    public static final String ARGUMENT_LONG_THREAD_POOL_FALLBACK_SIZE = "fallback-size";
    public static final String ARGUMENT_SHORT_THREAD_POOL_FALLBACK_SIZE = "B";
    public static final String DESCRIPTION_ARGUMENT_THREAD_POOL_FALLBACK_SIZE = "The number of threads that " +
            "are created dynamically when all core threads are busy.";
    public static final String DESCRIPTION_CONTEXT_THREAD_POOL_FALLBACK_SIZE = "These threads will be created on demand if all core " +
    ...
    public static final String ARGUMENT_LONG_THREAD_POOL_FALLBACK_LIFE_TIME = "lifetime";
    public static final String ARGUMENT_SHORT_THREAD_POOL_FALLBACK_LIFE_TIME = "T";
    ...
    public static final String DESCRIPTION_CONTEXT_THREAD_POOL_FALLBACK_LIFE_TIME = "Both the creation/destruction of a thread " +
    ...
    private final int coreThreadPoolSize, fallbackThreadPoolExtraSize;
    private final long fallbackThreadIdleLifeTime, processTimeOut, requestTimeOut;

    public UserConfiguration(URI serverBaseUri, File baseFolder, int coreThreadPoolSize, int fallbackThreadPoolExtraSize,
                             long fallbackThreadIdleLifeTime, long processTimeOut, long requestTimeOut) {
        this.serverBaseUri = serverBaseUri;
        this.baseFolder = baseFolder;
        this.coreThreadPoolSize = coreThreadPoolSize;
        this.fallbackThreadPoolExtraSize = fallbackThreadPoolExtraSize;
        this.fallbackThreadIdleLifeTime = fallbackThreadIdleLifeTime;
    ...
    private IWebConverterConfiguration makeConfiguration() {
        return new StandaloneWebConverterConfiguration(baseFolder, processTimeOut, coreThreadPoolSize,
                fallbackThreadPoolExtraSize, fallbackThreadIdleLifeTime, requestTimeOut);
    }
