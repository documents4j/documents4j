...
Function ConvertFile( inputFile, outputFile, formatEnumeration )
  ...
  If fileSystemObject.FileExists(inputFile) Then
    ...
    On Error Resume Next
    Set powerpointPresentation = powerpointApplication.Documents.Open(inputFile, False, True)
    If Err <> 0 Then
        WScript.Quit -2
    End If
    On Error GoTo 0
    ...
    If formatEnumeration = MagicFormatPDFA Then
      powerpointPresentation.ExportAsFixedFormat outputFile, _
                                       WdExportFormatPDF, _
                                       False, _
                                       , , , , , , , , , , _
                                       True
    Else
      powerpointPresentation.SaveAs outputFile, formatEnumeration
    End If
